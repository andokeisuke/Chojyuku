#ifndef _ROS_joycon_pub_val_h
#define _ROS_joycon_pub_val_h
...
namespace joycon
{
  ...
  class pub_val : public ros::Msg
  {
    ...
    const char * getType(){ return "joycon/pub_val"; };
    const char * getMD5(){ return "58427f44aac94a7705da0eb1e5227372"; };
