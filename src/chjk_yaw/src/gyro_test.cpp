...
int main(int argc,char **argv){
	...
	sub_raw = nh.subscribe("gyro_raw",10,get_gyro_raw);
	sub_pst = nh.subscribe("cmd",10,get_target_posture);
	pub     = nh.advertise <std_msgs::Float64>("gyro_yaw",1000);
...
void kalman_loop(double mean, double vari){
	...
	//P = (I-GC)P'
	p11 = (1.0-kgain1)*pp11;   p12 = (1.0-kgain1)*pp12;
	p21 = -kgain2*pp11 + pp21; p22 = -kgain2*pp12 + pp22;
	//x = x' + G(y-Cx')
