...
if("FALSE" STREQUAL "TRUE")
  set(mpc_SOURCE_PREFIX /home/ando/Chojyuku/src/mpc)
  set(mpc_DEVEL_PREFIX /home/ando/Chojyuku/devel)
  set(mpc_INSTALL_PREFIX "")
  set(mpc_PREFIX ${mpc_DEVEL_PREFIX})
else()
  set(mpc_SOURCE_PREFIX "")
  set(mpc_DEVEL_PREFIX "")
  set(mpc_INSTALL_PREFIX /home/ando/Chojyuku/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ando/Chojyuku/install/${idir}'.  ${_report}")
    endif()
